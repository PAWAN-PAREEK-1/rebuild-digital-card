...
<main class="main-home">
        ...
        <div class="spaciality">
            ...
            <div class="boxes">
                <div class="box">
                    <img class="icon" src="../images/Frame 116.svg" alt="">
                    <div class="text">
        ...
        <div class="options">
            ...
            <div class="flex-container">
                <div class="image-container">
                    <img src="../images/Rectangle 56.svg" alt="Your Image">
                </div>
                <div class="content-container">
                    ...
                    <div class="box-12"> <img src="../images/Frame 116.svg" alt="">
                        <h1>Cost-Effectiveness</h1>
                        <p>Save costs and contribute to <br> sustainability by switching to digital <br> business cards
                        </p>
                    </div>
        ...
        <div class="zigzag-container">
            <div class="zigzag">
                <img class="card11" src="../images/Rectangle 57.svg" alt="">
                <img class="card11" src="../images/Rectangle 57.svg" alt="">
                <img class="card11" src="../images/Rectangle 57.svg" alt="">
                <img class="card11" src="../images/Rectangle 57.svg" alt="">
            </div>
